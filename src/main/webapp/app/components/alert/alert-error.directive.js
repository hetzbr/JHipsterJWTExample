(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipJwtApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipJwtApp-error');
                var entityKey = httpResponse.headers('X-jhipJwtApp-params');
                if (errorHeader) {
